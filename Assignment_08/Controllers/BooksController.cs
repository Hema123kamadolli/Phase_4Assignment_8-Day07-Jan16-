...
using Assignment_08.Models;

namespace Assignment_08.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Name,Price,CategoryId,PublisherId")] Book book)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.BookCategories, "CategoryId", "CategoryId", book.CategoryId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Name,Price,CategoryId,PublisherId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
