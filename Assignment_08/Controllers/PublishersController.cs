...
namespace Assignment_08.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PublisherId,PublisherName,PublisherAddress")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PublisherId,PublisherName,PublisherAddress")] Publisher publisher)
        {
